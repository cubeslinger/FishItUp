...
--       cacheIcon:SetTexture("Rift", "reward_loot.png.dds")
...
--       cacheIcon:EventAttach( Event.UI.Input.Mouse.Left.Click, function() cD.window.totalsOBJ:SetVisible(not cD.window.totalsOBJ:GetVisible()) end, "Totals Button Pressed" )
